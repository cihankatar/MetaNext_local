...
# if not os.path.exists(train_im_path):
    ...
    if torch.cuda.is_available():
        ...
        data_train  = dataset(train_im_path[0:20],train_mask_path[0:20],cutout_pr,cutout_box, aug, transformations,mode)

    else:
        data_test   = dataset(test_im_path[0:20], test_mask_path[0:20],cutout_pr,cutout_box, aug, transformations,mode)
