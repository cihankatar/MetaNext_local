...
class Metafusion1(nn.Module):
    def __init__(self,n_classes):
        ...
        self.conv_module = nn.Sequential(nn.Conv2d(512,512,kernel_size=1,padding='same'),nn.BatchNorm2d(512),nn.ReLU())
...
#        merge = torch.cat((ca_out[3], conv_out[3]),dim=1)
