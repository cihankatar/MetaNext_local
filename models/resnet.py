...
from utils.batch_norm import BatchNorm1d, BatchNorm2d
...
def resnet_v1(input_size, resnet_depth, width_multiplier,config_res=None,training_mode=None, pretrained=None,cifar_stem=False, norm_type='bn'):
    model_params = {
    ...
    model= ResNet(input_size, params['block'], params['layers'], width_multiplier,
    ...
    if training_mode=="ssl":
        if pretrained:
            ...
            print("resnet simclr training with random weight init...")
        ...
        if os.path.exists(checkpoint_path):
            print("SSL Pretrained weights are being used")
            if torch.cuda.is_available():
