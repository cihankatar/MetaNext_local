...
from data.data_loader6 import loader
...
from models.Model6 import model_bce_topoMLP
...
def main():
    ...
    if args.mode == "ssl_pretrained" or args.mode == "supervised":
        model           = model_bce_topoMLP(config['n_classes'],config_res,args.mode,args.imnetpr).to(device)
